          ...
          <div className="max-w-4xl mx-auto">
            <div className="text-center mb-12">
              <span className="inline-block bg-primary/10 text-primary px-4 py-2 rounded-full text-sm font-medium mb-4">
                För Skönhetssalonger & Spa
              </span>
              <h1 className="text-4xl sm:text-5xl font-bold mb-6">
                Fyll er kalender med bokningar från lokala sökningar
              </h1>
              <p className="text-xl text-muted-foreground">
                Specialiserade lösningar för skönhetsbranschen
              </p>
            </div>
            ...
            <div className="bg-card border border-border rounded-2xl p-8 mb-12">
              ...
              <p className="text-muted-foreground mb-6">
                Vi arbetar på att bygga ut denna sida med detaljerad information för skönhetssalonger och spa.
              </p>
