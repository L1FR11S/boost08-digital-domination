      ...
      "faqs": [
        {
          ...
          "answer": "Boost08 är en intelligent tillväxtplattform för lokala företag som automatiserar digital närvaro, recensionshantering och lokal SEO med AI-driven teknologi. Vi hjälper företag att spara tid och öka sin lokala synlighet."
        },
        {
          "question": "Vilka typer av företag passar Boost08 för?",
          "answer": "Vi är specialiserade på lokala företag som kliniker, vårdcentraler, tandläkare, skönhetssalonger, spa, butikskedjor, restauranger och caféer. Perfekt för företag med en eller flera fysiska platser som vill öka sin lokala synlighet."
        },
        {
          "question": "Hur sparar jag tid med Boost08?",
          "answer": "Våra kunder sparar i genomsnitt 10-25 timmar per vecka genom att automatisera recensionssvar, uppdateringar av företagsinformation, social media-innehåll och lokal SEO-optimering. AI gör jobbet medan du fokuserar på ditt företag."
        },
        {
          "question": "Hur fungerar AI-recensionssvar?",
          "answer": "Vår AI analyserar recensionen, förstår kontexten och din bransch, och genererar ett professionellt och personligt svar som låter mänskligt. Du kan alltid godkänna eller redigera innan publicering."
        },
        {
          "question": "Vilka plattformar integrerar Boost08 med?",
          "answer": "Vi integrerar med 50+ plattformar inklusive Google Business Profile, Facebook, Instagram, Bing Places, Apple Maps, TripAdvisor och många fler. All data synkas automatiskt överallt."
        },
        {
          "question": "Kan jag testa Boost08 gratis?",
          "answer": "Ja! Vi erbjuder en gratis konsultation där vi analyserar er nuvarande digitala närvaro och visar hur mycket tid och pengar ni kan spara med Boost08."
        }
      ],
      "case_studies": [
        {
      ...
      "pricing": {
        ...
        "tiers": [
          ...
          },
          {
            ...
            "includes": ["All Professional features", "Custom integrations", "Dedicated account manager", "Advanced analytics"]
          }
        ],
